...
//         {
//             //Given
//             var torcedor = new UsuarioServices().CriarUsuario("torcedor", "Carlos", Perfil.CBF);
...
//         {
//             //Given
//             var cbf = new UsuarioServices().CriarUsuario("admin", "Carlos", Perfil.CBF);
//             var campeonatoBrasileirao = new FabricaDeCampeonato().CriarCampeonato();
...
//             var campeonatoBrasileirao = new FabricaDeCampeonato().CriarCampeonato();
//             campeonatoBrasileirao.CadastrarTimes(cbf, GeradorDeTimesCompleto());
//             var torcedor = new UsuarioServices().CriarUsuario("torcedor", "Carlos", Perfil.Torcedor);
